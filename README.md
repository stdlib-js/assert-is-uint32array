...
```javascript
isUint32Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint32array@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/assert-is-uint32array/tags). For example,

```javascript
isUint32Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint32array@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint32array@umd/browser.js"></script>
```
